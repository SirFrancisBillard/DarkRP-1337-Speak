...
local my_language = {
	...
	youre_arrested_by = "Y0u hav3 b33n arr3st3d by %s.",
	youre_unarrested_by = "Y0u w3r3 unarr3st3d by %s.",
	hes_arrested = "%s has b33n arr3st3d f0r %d s3c0nds!",
	hes_unarrested = "%s has b33n r3l3as3d fr0m jail!",
	warrant_ordered = "%s 0rd3r3d a s3arch warrant f0r %s. R3as0n: %s",
